 ...
 * 
 */
public class STOntologyManagerSesame4Impl<MODELTYPE extends RDFModel> extends STOntologyManager<MODELTYPE> {

	protected static Logger logger = LoggerFactory.getLogger(STOntologyManagerSesame4Impl.class);

	STOntologyManagerSesame4Impl(Project<MODELTYPE> project) {
		super(project, new ARTModelFactorySesame4Impl());
	}


	@Override
	public String getId() {
		return "it.uniroma2.art.semanticturkey.ontology.sesame2.STOntologyManagerSesame4Impl";
	}
