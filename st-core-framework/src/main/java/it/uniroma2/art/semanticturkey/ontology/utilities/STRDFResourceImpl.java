...
public abstract class STRDFResourceImpl extends STRDFNodeImpl implements STRDFResource {
	...
	STRDFResourceImpl(ARTResource node, RDFResourceRole role, boolean explicit) {
		super(node, explicit);
		this.role = role;
	}

	STRDFResourceImpl(ARTResource node, RDFResourceRole role, boolean explicit, String show) {
	...
	public void setRole(RDFResourceRole role) {
		this.role = role;
	}
}
