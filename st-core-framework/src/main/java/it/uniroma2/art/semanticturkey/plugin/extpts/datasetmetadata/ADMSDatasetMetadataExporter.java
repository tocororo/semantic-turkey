...
public class ADMSDatasetMetadataExporter extends
		AbstractPlugin<DatasetMetadataExporterSettings, ADMSDatasetMetadataExporterSettings, STProperties, STProperties, ADMSDatasetMetadataExporterFactory>
	...
	public Model produceDatasetMetadata(Project project, RepositoryConnection conn, IRI dataGraph)
		...
		try {
			try (RepositoryConnection metadataConnection = tempMetadataRepository.getConnection()) {
				 ...
				 * project);
				 */
				ADMSDatasetMetadataExporterSettings pluginSettings = getClassLevelProjectSettings(project);
