...
public class DCATAPDatasetMetadataExporter extends
		AbstractPlugin<DatasetMetadataExporterSettings, DCATAPDatasetMetadataExporterSettings, STProperties, STProperties, DCATAPDatasetMetadataExporterFactory>
	...
	public Model produceDatasetMetadata(Project project, RepositoryConnection conn, IRI dataGraph)
		...
		try {
			try (RepositoryConnection metadataConnection = tempMetadataRepository.getConnection()) {
				DCATAPDatasetMetadataExporterSettings pluginSettings = getClassLevelProjectSettings(project);
