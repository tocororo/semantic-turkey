 ...
 */
public class RDFSRenderingEngineFactory implements PluginFactory<RDFSRenderingEngineConfiguration> {
	...
	@Override
	public RDFSRenderingEngineConfiguration createPluginConfiguration(String configType) throws UnsupportedPluginConfigurationException, UnloadablePluginConfigurationException,
