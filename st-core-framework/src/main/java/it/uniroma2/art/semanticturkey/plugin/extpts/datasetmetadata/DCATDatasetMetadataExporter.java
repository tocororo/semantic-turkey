	...
	public Model produceDatasetMetadata(Project<?> project, RepositoryConnection conn, IRI dataGraph)
		...
		try {
			try (RepositoryConnection metadataConnection = tempMetadataRepository.getConnection()) {
				...
				String dataset_contact_point = pluginSettings.dataset_contact_point;
				...
				String dataset_accrual_periodicy = pluginSettings.dataset_accrual_periodicy;
				...
				String dataset_landing_page = pluginSettings.dataset_landing_page;
				...
				String distribution_access_url = pluginSettings.distribution_access_url;
				...
				String distribution_download_url = pluginSettings.distribution_download_url;
				...
				String distribution_byte_size = pluginSettings.distribution_byte_size;
