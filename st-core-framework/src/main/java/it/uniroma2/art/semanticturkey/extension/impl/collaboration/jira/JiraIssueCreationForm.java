...
public class JiraIssueCreationForm implements STProperties {
	...
	@STProperty(description = "Summary for the new Issue", displayName = "Summary for the new Issue")
	@Required
	public String summary;
	
	@STProperty(description = "Description of the new Issue", displayName = "Description of the new Issue")
