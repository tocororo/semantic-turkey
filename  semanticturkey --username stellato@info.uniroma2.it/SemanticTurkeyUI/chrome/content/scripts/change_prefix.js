...
function onAccept() {
	...
	httpGet(
			"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=change_nsprefixmapping&prefix="
					+ encodeURIComponent(newPrefix)
					+ "&ns="
					+ encodeURIComponent(parameters.namespace), false,
			parameters);
	close();
}