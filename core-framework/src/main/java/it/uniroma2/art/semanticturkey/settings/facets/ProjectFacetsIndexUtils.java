...
public class ProjectFacetsIndexUtils {
    ...
    public static void createFacetIndexAPI(List<ProjectInfo> projectInfoList) throws PropertyNotFoundException, InvalidProjectNameException,
    ...
    public static void recreateFacetIndexForProjectAPI(String projectName, ProjectInfo projectInfo) throws PropertyNotFoundException,
    ...
    private static void addProjectToIndex(ProjectInfo projectInfo, boolean removePrevIndex, IndexWriter writer)
    ...
    public static void deleteProjectFromFacetIndex(String projectName, IndexWriter writer) throws IOException {
        BooleanQuery.Builder builderBoolean = new BooleanQuery.Builder();
        builderBoolean.add(new TermQuery(new Term(PROJECT_NAME, projectName)), BooleanClause.Occur.MUST);
        writer.deleteDocuments(builderBoolean.build());
    }
