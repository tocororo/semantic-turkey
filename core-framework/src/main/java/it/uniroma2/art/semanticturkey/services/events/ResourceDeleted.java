...
/**
 * A {@link Event} raised when a resource has been deleted. Usually, raised within a transaction affecting a
 * {@link Repository}, this event can be handled through a {@link TransactionalEventListener}.
 * 
 * @author <a href="mailto:fiorelli@info.uniroma2.it">Manuel Fiorelli</a>
 *
 */
public class ResourceDeleted extends Event {
	...
	public ResourceDeleted(Resource resource, RDFResourceRole role, Resource wgraph, Repository repository,
			Project project) {
		super(resource);
		this.role = role;
		this.wgraph = wgraph;
