 ...
 *
 */
public class SemTurkeyQuickTest {
...
*/	    
	...
	public static void main(String[] args) throws RepositoryUpdateException {
        ...
        System.out.println("adding Ontology Import: " + importURI2 + " From Web To Local File");
        //result = Metadata.addOntImport(Metadata.fromWebToMirror, importURI2, importAltURL2, importFile2);
        result = metadata.addOntImport(metadata.fromWebToMirror, importURI2, importAltURL2, importFile2);
        System.out.println("\nxml content:\n\n" + XMLHelp.XML2String(result, true));         
