...
XPointerService.prototype = {
  classID: Components.ID("{4e40e0d7-1d71-49f0-83d9-ccfd883c7033}"),  
  
  QueryInterface: XPCOMUtils.generateQI([Components.interfaces.nsIXPointerService]),  
};
...
//}
const NSGetFactory = XPCOMUtils.generateNSGetFactory([XPointerService]);  
