...
art_semanticturkey.init = function(){
	...
	try {
		//SKOS
		var xmlResp = art_semanticturkey.STRequests.ICV.listConceptsWithOnlySKOSAltLabel();
		...
		//SKOSXL
		var xmlResp = art_semanticturkey.STRequests.ICV.listConceptsWithOnlySKOSXLAltLabel();
		var data = xmlResp.getElementsByTagName("data")[0];
		var records = data.getElementsByTagName("record");
		for (var i=0; i<records.length; i++){
			var concept = records[i].getAttribute("concept");
