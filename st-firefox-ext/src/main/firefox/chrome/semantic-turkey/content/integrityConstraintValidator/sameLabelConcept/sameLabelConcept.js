...
art_semanticturkey.init = function() {
	...
	try {
		...
		var buttonLabel;
		if (ontoType == "SKOS"){
			xmlResp = art_semanticturkey.STRequests.ICV.listConceptsWithSameSKOSPrefLabel();
			buttonLabel = "skos:prefLabel";
		} else if (ontoType == "SKOS-XL") {
			xmlResp = art_semanticturkey.STRequests.ICV.listConceptsWithSameSKOSXLPrefLabel();
			buttonLabel = "skosxl:prefLabel";
		}
		
		var record = xmlResp.getElementsByTagName("record");
