...
art_semanticturkey.init = function(){
	...
	try {
		var xmlResp = art_semanticturkey.STRequests.ICV.listCyclicConcepts();
...
art_semanticturkey.graphButtonClickListener = function(){
	...
	window.openDialog("chrome://semantic-turkey/content/integrityConstraintValidator/cyclicConcept/graph/graph.html", "_blank",
