...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function overlapScrollbars() {
      var tmpSb = document.createElementNS("http://www.w3.org/1999/xhtml", 'div'),
          tmpSbInner = document.createElementNS("http://www.w3.org/1999/xhtml", 'div');
    ...
    function patchDisplay(from, to, intact) {
      ...
      var scratch = document.createElementNS("http://www.w3.org/1999/xhtml", "div");
    ...
    function measureLine(line, ch) {
      ...
      if (ie && top == 0 && left == 0) {
        var backup = document.createElementNS("http://www.w3.org/1999/xhtml", "span");
        backup.innerHTML = "x";
  ...
  var lineSep = function () {
    var te = document.createElementNS("http://www.w3.org/1999/xhtml", "textarea");
    te.value = "foo\nbar";
  ...
  var escapeElement = document.createElementNS("http://www.w3.org/1999/xhtml", "pre");
