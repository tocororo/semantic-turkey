...
art_semanticturkey.getOntologyMirror_RESPONSE = function(responseElement){
	var mirrors = responseElement.getElementsByTagName("Mirror");
	var node = document.getElementById("MirrorTreeChildren");
	for (var i = 0; i < mirrors.length; i++) {
		art_semanticturkey.parseMirror(mirrors[i], node);
	}
};

art_semanticturkey.parseMirror = function(mirrorNode, node) {
