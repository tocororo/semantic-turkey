 ...
 * 
 */
art_semanticturkey.dataRangeList = function(){
	...
	dataRangelist[5] = "http://www.w3.org/2001/XMLSchema#date";
	dataRangelist[6] = "http://www.w3.org/2001/XMLSchema#dateTime";
	dataRangelist[7] = "http://www.w3.org/2001/XMLSchema#time";
	
	this.getLength = function(){
		return dataRangelist.length;	
	};
	this.getElement = function(id){
		return dataRangelist[id];
	};
