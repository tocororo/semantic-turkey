...
art_semanticturkey.setAsTopConcept = function(idxRow) {
	...
	window.openDialog("chrome://semantic-turkey/content/skos_icv/danglingConcept/setAsTopConceptOfDialog.xul",
			"_blank", "chrome,dependent,dialog,modal=yes,resizable,centerscreen",
			parameters);
...
art_semanticturkey.selectBroaderConcept = function(idxRow) {
	...
	if (danglingInScheme.length > 1) {
		...
		parameters.returnedValue == null;
		window.openDialog("chrome://semantic-turkey/content/skos_icv/danglingConcept/selectSchemeDialog.xul",
	...
	parameters.returnedValue == null;
	window.openDialog("chrome://semantic-turkey/content/skos_icv/danglingConcept/selectBroaderDialog.xul",
			"_blank", "chrome,dependent,dialog,modal=yes,resizable,centerscreen", parameters);
