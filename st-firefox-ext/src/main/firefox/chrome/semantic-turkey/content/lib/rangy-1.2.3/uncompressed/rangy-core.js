...
//            dom.getBody(document).appendChild(testTextNode);
            document.documentElement.appendChild(testTextNode);
            ...
            document.documentElement/*.body*/.appendChild(el);
            ...
            document.documentElement/*.body*/.removeChild(el);
            ...
            document.documentElement.removeChild(testTextNode);
            range.detach();
            range2.detach();
        })();
...
rangy.createModule("WrappedSelection", function(api, module) {
    ...
    var body = /*dom.getBody(document)*/ document.documentElement;
