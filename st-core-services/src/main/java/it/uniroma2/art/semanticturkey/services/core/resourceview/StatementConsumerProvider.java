...
//		LexicalizationsStatementConsumer lexicalizationsStatementConsumer = new LexicalizationsStatementConsumer();
		BroadersStatementConsumer broaderStatementConsumer = new BroadersStatementConsumer(customRangeProvider);
		SubPropertyOfStatementConsumer subPropertyOfStatementConsumer = new SubPropertyOfStatementConsumer(customRangeProvider);
//		PropertyFactesStatementConsumer propertyFactesStatementConsumer = new PropertyFactesStatementConsumer();
		...
		OntologyImportsStatementConsumer ontologyImportsStatementConsumer = new OntologyImportsStatementConsumer(customRangeProvider);
		...
		TopConceptOfStatementConsumer topConceptOfStatementConsumer = new TopConceptOfStatementConsumer(customRangeProvider);
		InSchemeStatementConsumer inSchemeStatementConsumer = new InSchemeStatementConsumer(customRangeProvider);
		SKOSCollectionMembersStatementConsumer skosCollectionMemberStatementConsumer = new SKOSCollectionMembersStatementConsumer(customRangeProvider);
//		SKOSOrderedCollectionMemberStatementConsumer skosOrderedCollectionMemberStatementConsumer = new SKOSOrderedCollectionMemberStatementConsumer();
		LabelRelationsStatementConsumer labelRelationStatementConsumer = new LabelRelationsStatementConsumer(customRangeProvider);
