...
//TODO this class should be deleted, since now the new service, ManchesterHandler, is called instead of this one

@GenerateSTServiceController
@Validated
@Component
public class ManchesterHandlerOLD extends STServiceAdapterOLD {
