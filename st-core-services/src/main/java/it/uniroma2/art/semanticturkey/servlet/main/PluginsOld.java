...
@Component
public class PluginsOld extends ServiceAdapter {
	protected static Logger logger = LoggerFactory.getLogger(PluginsOld.class);
	...
	@Autowired
	public PluginsOld(@Value("Plugins") String id) {
		super(id);
	}
