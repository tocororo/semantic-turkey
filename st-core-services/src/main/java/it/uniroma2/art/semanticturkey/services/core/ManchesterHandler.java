...
public class ManchesterHandler  extends STServiceAdapter {
	...
	public Response getAllDLExpression(ARTURIResource classUri, 
		...
		ARTStatementIterator iter = model.listStatements(classUri, NodeFilters.ANY, NodeFilters.ANY, false, getWorkingGraph());
		while(iter.hasNext()){
	...
	@GenerateSTServiceController
	public Response createRestriction(ARTURIResource classUri, ARTURIResource exprType, String manchExpr) throws ManchesterSyntaxException, ModelUpdateException{
		OWLModel model = getOWLModel();
