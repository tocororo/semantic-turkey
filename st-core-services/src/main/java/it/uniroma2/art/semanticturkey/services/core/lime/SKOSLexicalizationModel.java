...
public class SKOSLexicalizationModel implements LexicalizationModel {
	...
	public Map<String, LanguageStatistics> computeStatistics(RepositoryConnection repConn,
		...
		TupleQuery query = repConn.prepareTupleQuery(
			...
			" WHERE {                                                                                     \n"+
			" 	?reference skos:prefLabel|skos:altLabel|skos:hiddenLabel ?label .                         \n"+
	...
	@Override
	public IRI getIRI() {
		return SimpleValueFactory.getInstance().createIRI("http://www.w3.org/2004/02/skos/core");
	}
