...
function onAccept() {
	...
	if (selectItem == 1) {
		...
		if (sel.getAttribute("checked")) {
			...
			httpGet(
					"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=addFromWeb&baseuri="
							+ encodeURIComponent(uri)
							+ "&alturl="
							+ encodeURIComponent(alturl), false, parameters);
		} else {
			httpGet(
					"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=addFromWeb&baseuri="
		...
		if (sel.getAttribute("checked")) {
			var alturl = document.getElementById("alternativeUrl").value;
			httpGet(
					"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=addFromWebToMirror&baseuri="
							+ encodeURIComponent(uri)
							+ "&mirrorFile="
			...
			httpGet(
					"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=addFromWebToMirror&baseuri="
							+ encodeURIComponent(uri)
							+ "&mirrorFile="
							+ encodeURIComponent(local), false, parameters);
		}
		...
		httpGet(
				"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=addFromLocalFile&baseuri="
						+ encodeURIComponent(base)
						+ "&mirrorFile="
						+ encodeURIComponent(destLocalFile)
						+ "&localFilePath="
						+ encodeURIComponent(srcLocalFile), false, parameters);
		...
		if (sel.getAttribute("checked")) {
			var alturl = document.getElementById("alternativeUrl").value;
			httpGet(
					"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=downloadFromWebToMirror&baseuri="
							+ encodeURIComponent(uri)
							+ "&mirrorFile="
							+ encodeURIComponent(local)
							+ "&alturl="
		...
		if (sel.getAttribute("checked")) {
			var alturl = document.getElementById("alternativeUrl").value;
			httpGet(
					"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=downloadFromWeb&baseuri="
							+ encodeURIComponent(uri)
							+ "&alturl="
							+ encodeURIComponent(alturl), false, parameters);
		} else {
		...
		var destLocalFile = document.getElementById("destLocalFile").value;
		httpGet(
				"http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=metadata&request=getFromLocalFile&baseuri="
						+ encodeURIComponent(base)
						+ "&mirrorFile="
						+ encodeURIComponent(destLocalFile)
						+ "&localFilePath="
