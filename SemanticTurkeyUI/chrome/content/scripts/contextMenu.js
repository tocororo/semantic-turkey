...
ContexMenu.annotateSelection = function() {    
    ...
    window.content.document.location.href = "http://127.0.0.1:1979/semantic_turkey/resources/stserver/STServer?service=annotate&document=" + url + "&selection=" + seln;
}
//NScarpato 18/07/07 add Visualization option function this function select the visualization type Normal o debug 
ContexMenu.manageOntologyMirror = function(){
	window.open("chrome://semantic-turkey/content/mirror.xul", "showmore", "chrome, modal,resizable");
}
...
ContexMenu.exportRepository = function(){
	window.openDialog("chrome://semantic-turkey/content/exportRepository.xul", "_blank","modal=yes,resizable,centerscreen");
}
ContexMenu.loadRdf = function(){
	window.openDialog("chrome://semantic-turkey/content/loadRepository.xul", "_blank","modal=yes,resizable,centerscreen");
