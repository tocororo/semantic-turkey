...
window.onload = function() {
	...
	document.getElementById("openMainProject").addEventListener("command",
			art_semanticturkey.openMainProject, true);
	...
	document.getElementById("restartFirefox").addEventListener("command",
			art_semanticturkey.closeAndRestartFirefox, true);
