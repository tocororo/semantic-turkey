...
var BridgeModule = {
    ...
    _myFactory : {
        createInstance : function(outer, iid) {
            ...
            if (!(instance)) {
                instance = new BridgeComponent(); // BridgeComponent is declared below
            }
...
BridgeComponent.prototype.initialize = function (packageLoader, trace) {
    ...
    try {
        ...
        var jarFilepaths = [
            ...
            javaPath + "artontapi-1.0.jar",
            javaPath + "log4j-1.2.13.jar",
            javaPath + "commons-logging.jar",
            javaPath + "googleapi.jar",
    ...
    try {
    	 ...
    	 stloader.loadSubScript('chrome://semantic-turkey/content/scripts/initialize.js');
    	 var stloader2 = Components.classes["@mozilla.org/moz/jssubscript-loader;1"].getService(Components.interfaces.mozIJSSubScriptLoader);
    	 stloader2.loadSubScript('chrome://semantic-turkey/content/http/http.js');
		 startST();
