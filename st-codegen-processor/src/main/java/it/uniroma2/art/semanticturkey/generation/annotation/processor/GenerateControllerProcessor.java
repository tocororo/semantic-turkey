...
@SupportedAnnotationTypes("it.uniroma2.art.semanticturkey.generation.annotation.GenerateController")
@SupportedSourceVersion(SourceVersion.RELEASE_6)
public class GenerateControllerProcessor extends AbstractProcessor {

	public GenerateControllerProcessor() {
		super();
	}
	...
	public boolean process(Set<? extends TypeElement> annotations,
		...
		for (Element i : roundEnv
				.getElementsAnnotatedWith(GenerateController.class)) {
