...
public abstract class ServiceTest {
	...
	final static String BMProjectDir = "../SemanticTurkeyBM";
	...
	public void baseInitialize() throws IOException {
		...
		Utilities.recursiveCopy(new File(BMProjectDir, dataDirName), fakeSTSourceDataDir);
		...
		Utilities.recursiveCopy(new File(BMProjectDir, extensionsDirName), fakeSTSourceExtensionsDir);
