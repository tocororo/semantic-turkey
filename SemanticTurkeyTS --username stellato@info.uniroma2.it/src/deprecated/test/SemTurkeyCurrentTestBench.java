 ...
 *
 */
public class SemTurkeyCurrentTestBench {
	...
	public SemTurkeyCurrentTestBench() {
		/*
...
*/	    
	...
	public static void main(String[] args) throws RepositoryUpdateException {
        ...
        result = systemStart.startSystem("http://art.info.uniroma2.it/ontologies/starred", "sesame");
        ...
        System.out.println("adding Ontology Import: " + importURI1 + " From Web To Local File: " + importFile1);
        ...
        System.out.println(repository.getNSForPrefix(""));
        
        result = metadata.getDefaultNamespace();
        System.out.println("\nxml content:\n\n" + XMLHelp.XML2String(result, true));
