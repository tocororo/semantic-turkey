...
public class LexicalFormsStatementConsumer extends AbstractPropertyMatchingStatementConsumer {
	...
	public LexicalFormsStatementConsumer(CustomFormManager cfManager, ProjectCustomViewsManager projCvManager) {
		super(cfManager, projCvManager, "lexicalForms", Collections.singleton(ONTOLEX.LEXICAL_FORM),
