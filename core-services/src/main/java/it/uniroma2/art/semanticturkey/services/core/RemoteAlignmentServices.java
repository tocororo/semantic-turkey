...
public class RemoteAlignmentServices extends STServiceAdapter {
     ...
     * @param rightDataset    right dataset. A {@code null} values indicates that any dataset is fine
     * @param allowReordering left and right datasets may be matched in the reverse order
     * @return
     * @throws AlignmentServiceException
     */
    @STServiceOperation
    ...
    @STServiceOperation
    public synchronized String getDefaultRemoteAlignmentServiceId() throws STPropertyAccessException, NoSuchSettingsManager {
        return ((RemoteAlignmentServiceProjectSettings) exptManager.getSettingsDefault(null, null, null, RemoteAlignmentServiceProjectSettingsManager.class.getName(), Scope.PROJECT, Scope.SYSTEM)).configID;
    }
    ...
    public synchronized void deleteRemoteAlignmentService(String id) throws ConfigurationNotFoundException,
            NoSuchConfigurationManager, STPropertyAccessException, STPropertyUpdateException, NoSuchSettingsManager, PropertyNotFoundException, WrongPropertiesException, IOException {
        RemoteAlignmentServicesStore cm = (RemoteAlignmentServicesStore) exptManager
                .getConfigurationManager(RemoteAlignmentServicesStore.class.getName());
        ...
        String defaultConfigId = ((RemoteAlignmentServiceProjectSettings)exptManager.getSettingsDefault(null, null, null, RemoteAlignmentServiceProjectSettingsManager.class.getName(), Scope.PROJECT, Scope.SYSTEM)).configID;
        if (defaultConfigId.equals(id)) { // remove default
            exptManager.storeSettingDefault(RemoteAlignmentServiceProjectSettingsManager.class.getName(),null, null, null, Scope.PROJECT, Scope.SYSTEM, "configID", null);
        }
    }
    ...
    Pair<String, Boolean> getAlignmentServiceForProject()
